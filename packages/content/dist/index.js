...
function getContentClient(config) {
  ...
  contentClient = supabaseJs.createClient(supabaseUrl, supabaseKey, {
    auth: {
...
exports.getBlogPostCount = getBlogPostCount;
exports.getBlogPosts = getBlogPosts;
exports.getBlogTags = getBlogTags;
exports.getContentClient = getContentClient;
exports.getFeaturedPosts = getFeaturedPosts;
exports.getNovansaSupabasePublishableKey = getNovansaSupabasePublishableKey;
exports.getNovansaSupabaseUrl = getNovansaSupabaseUrl;
exports.getRelatedPosts = getRelatedPosts;
exports.resetContentClient = resetContentClient;
